  ...
  return ( 
    ...
    <div className="w-full max-w-md bg-white shadow-md rounded-lg p-8 border border-gray-200">
      ...
      state.message && !state.success && (
        ...
        <input type="text" className="w-full border border-gray-200 p-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" 
        name="subject"
        placeholder="Subject"
        //required
        />
        ...
        <button 
        className="w-full bg-blue-600 text-white p-3 rounded hover:bg-700 transition disabled:opacity-50"
        type="submit"
        >
          Submit
          </button>
